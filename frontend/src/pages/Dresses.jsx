...
const Dresses = () => {
  ...
  const [availability, setAvailability] = useState([]); // Array of booleans
  ...
  useEffect(() => {
    ...
    let filtered = products.filter((product) => product.category === 'Dresses');
    ...
    <div className="flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t">
      ...
      <div className="flex-1">
        <div className="flex justify-between text-base sm:text-2xl mb-4">
          <Title text1={'DRESSES'} text2={'COLLECTION'} />
